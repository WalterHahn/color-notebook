...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Color\", function() { return Color; });\n/* harmony import */ var randum__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! randum */ \"./node_modules/randum/index.js\");\n/* harmony import */ var randum__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(randum__WEBPACK_IMPORTED_MODULE_0__);\n\r\n\r\nrandum__WEBPACK_IMPORTED_MODULE_0___default.a.int('color-part', 0, 255);\r\n\r\nfunction hexValue(component) {\r\n  const hex = component.toString(16);\r\n  return hex.length == 1 ? \"0\" + hex : hex;\r\n}\r\n\r\nclass Color {\r\n  constructor(r,g,b,a) {\r\n    this.r = r || 0;\r\n    this.g = g || 0;\r\n    this.b = b || 0;\r\n    this.a = a || 0;\r\n  }\r\n\r\n  randomize() {\r\n    this.r = randum__WEBPACK_IMPORTED_MODULE_0___default.a.get('color-part');\r\n    this.g = randum__WEBPACK_IMPORTED_MODULE_0___default.a.get('color-part');\r\n    this.b = randum__WEBPACK_IMPORTED_MODULE_0___default.a.get('color-part');\r\n    this.a = 1; \r\n\r\n    return this;\r\n  }\r\n\r\n  hex() {\r\n    return \"#\" + hexValue(this.r) + hexValue(this.g) + hexValue(this.b);\r\n  }\r\n}\r\n\n\n//# sourceURL=webpack:///./src/colors.js?");
...
eval("var pug = __webpack_require__(/*! ../../node_modules/pug-runtime/index.js */ \"./node_modules/pug-runtime/index.js\");\n\nfunction template(locals) {var pug_html = \"\", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (colors) {pug_html = pug_html + \"\\u003Cdiv id=\\\"colors\\\"\\u003E\";\n// iterate colors\n;(function(){\n  var $$obj = colors;\n  if ('number' == typeof $$obj.length) {\n      for (var i = 0, $$l = $$obj.length; i < $$l; i++) {\n        var color = $$obj[i];\npug_html = pug_html + \"\\u003Cdiv\" + (\" class=\\\"color\\\"\"+pug.attr(\"style\", pug.style({background: color}), true, true)+pug.attr(\"data-index\", i, true, true)) + \"\\u003E&nbsp;\\u003Cinput\" + (\" type=\\\"text\\\"\"+pug.attr(\"value\", color, true, true)) + \"\\u003E\\u003C\\u002Fdiv\\u003E\";\n      }\n  } else {\n    var $$l = 0;\n    for (var i in $$obj) {\n      $$l++;\n      var color = $$obj[i];\npug_html = pug_html + \"\\u003Cdiv\" + (\" class=\\\"color\\\"\"+pug.attr(\"style\", pug.style({background: color}), true, true)+pug.attr(\"data-index\", i, true, true)) + \"\\u003E&nbsp;\\u003Cinput\" + (\" type=\\\"text\\\"\"+pug.attr(\"value\", color, true, true)) + \"\\u003E\\u003C\\u002Fdiv\\u003E\";\n    }\n  }\n}).call(this);\n\npug_html = pug_html + \"\\u003C\\u002Fdiv\\u003E\";}.call(this,\"colors\" in locals_for_with?locals_for_with.colors:typeof colors!==\"undefined\"?colors:undefined));;return pug_html;};\nmodule.exports = template;\n\n//# sourceURL=webpack:///./src/templates/index.pug?");
